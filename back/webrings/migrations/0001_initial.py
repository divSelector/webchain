    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_type', models.CharField(choices=[('free', 'Free'), ('subscriber', 'Subscriber')], default='subscriber', max_length=12)),
                ('date_updated', models.DateTimeField(auto_now=True, validators=[webrings.validators.validate_date_not_in_future])),
                ('stripe_checkout_session_id', models.CharField(blank=True, default=None, max_length=255, null=True, unique=True)),
                ('stripe_customer_id', models.CharField(blank=True, default=None, max_length=255, null=True, unique=True)),
                ('stripe_subscription_id', models.CharField(blank=True, default=None, max_length=255, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Page',
